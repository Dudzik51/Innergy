import { updateSelectedServices, calculatePrice, initConfig } from ".";
...
describe.each([2020, 2021, 2022])("calculatePrice.zero (%i)", (year: number) => {
...
])("calculatePrice.singleService (%s, %i)", (service: string, year: number, expectedPrice) => {
...
describe.each([
    ...
    [2021, 300],
    [2022, 0]
])("calcularePrice.photographyWithWeddingSessionPrice (%i increase by %i)", (year: number, increase) => {
    test("price matches requirements", () => {
...
describe.each([
    ...
    [2021, 300],
    [2022, 300]
])("calcularePrice.videoRecordingWithWeddingSessionPrice (%i increase by %i)", (year: number, increase) => {
    test("price matches requirements", () => {
...
describe.each([
    ...
    [2021, 500],
    [2022, 600]
])("calcularePrice.videoRecordingWithPhotographyPrice (%i increase by %i)", (year: number, increase) => {
    test("price matches requirements", () => {
